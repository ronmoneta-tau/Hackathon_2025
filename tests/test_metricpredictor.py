...
def test_predict_using_knn_returns_float():
    ...
    pred = predictor.predict_using_knn(group, idx_to_hide=2, group_hidden=group.drop(2), measurement='measurement')
